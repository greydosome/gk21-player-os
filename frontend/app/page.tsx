                  ...
                  <div className="space-y-5">
                    {(
                      [
                        ...
                        { label: "반응속도", value: reactionScore, setValue: setReactionScore },
                        { label: "사이드 이동", value: sideScore, setValue: setSideScore },
                        { label: "어깨 상태", value: shoulderScore, setValue: setShoulderScore },
                      ] as const
                    ).map((field) => (
